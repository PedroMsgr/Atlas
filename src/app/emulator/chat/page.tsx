...
const initialMessages = [
  {
    ...
    sender: "lawyer",
    content:
      "Buenos días, soy Carlos Jiménez, su abogado asignado para el caso de accidente. ¿En qué puedo ayudarle?",
    timestamp: "10:03",
  },
  {
    id: 2,
    sender: "client",
    content:
      "Hola, gracias por contactarme. Quería saber qué documentación necesitaré para mi caso.",
    timestamp: "10:15",
  },
  {
    id: 3,
    sender: "lawyer",
    content:
      "Necesitaremos el informe policial, informes médicos y fotografías del accidente si las tiene. También cualquier factura relacionada con gastos médicos.",
    timestamp: "10:18",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    sender: "lawyer",
    content:
      "Cuando tenga la documentación lista, podemos programar una reunión para revisarla y determinar la estrategia a seguir para su reclamación.",
    timestamp: "10:28",
  },
];
    ...
    if (newMessage.trim()) {
      ...
      setTimeout(() => {
        const autoResponse = {
          ...
          sender: "lawyer",
          content:
            "Entendido. Me pondré en contacto con usted pronto para los siguientes pasos.",
          timestamp: new Date().toLocaleTimeString([], {
            hour: "2-digit",
            minute: "2-digit",
          }),
