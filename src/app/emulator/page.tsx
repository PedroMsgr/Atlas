    ...
    <Head>
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
        ...
        <div className="w-full h-64 overflow-hidden">
         <img src="https://firebasestorage.googleapis.com/v0/b/universo-legal-4dace.firebasestorage.app/o/images%2F1748913926418-6750160.jpg?alt=media&token=fa247a66-9228-47a2-b195-20991cd1ceb9" alt="Banner principal" className="w-full h-full object-cover" />
       </div>
      ...
      <article key={"article-995baa57-5e05-41c3-9995-7972b935e789"} className="mb-6 p-4 bg-slate-100 rounded-lg">
        ...
        <a href="https://www.youtube.com/watch?v=JvzjcJG1NCc&t=2639s" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Leer noticia completa</a>
      </article>
