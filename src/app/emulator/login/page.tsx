  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 dark:bg-slate-900">
          ...
          <CardContent className="space-y-6 pt-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="remember"
                  className="border-slate-300 data-[state=checked]:bg-blue-700 data-[state=checked]:border-blue-700 dark:border-slate-600"
                />
                <label
                  htmlFor="remember"
      ...
      <footer className="border-t border-slate-200 py-4 text-center text-sm text-slate-500 dark:border-slate-800 dark:text-slate-400">
        <p>
          © {new Date().getFullYear()} AsesoLegal Patinetes. Todos los derechos
          reservados.
        </p>
      </footer>
    </div>
